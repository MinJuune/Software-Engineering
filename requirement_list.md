...
| 6   | 관리자가 등록된 대여소 목록을 조회하고 필요시 특정 대여소를 선택해 삭제할 수 있어야 한다 | 대여소 목록 조회 |
| 7   | 관리자가 특정 대여소를 선택해 상세내용을 확인할 수 있어야 한다 | 대여소 상세내용 |
| 8   | 회원이 대여소 이름으로 대여소를 검색할 수 있어야 한다| 대여소 검색 |
| 9   | 회원이 특정 대여소를 선택해 상세정보 화면을 볼 수 있고 상세 화면에서 대여나 예약 대기를 신청할 수 있다  | 대여소 상세정보 |
| 10  | | |
| 11  |             |              |
| 12  |             |              |
| 13  |             |              |

...
| 3. (option)관리자가 특정 자전거 항목을 삭제      |4. 리스트에서 해당 자전거 제거  |
|              |                 |
|              |                 |
...
|  3. (option)사용 가능한 자전거 중 선택 후 즉시 대여 버튼 클릭            |   4. 즉시 대여 완료 시 회원에게 문자알림 전송              |
|              |                 |
|              |                 |
...
|--------------|-----------------|
|  1. 회원이 대여소 리스트에서 특정 대여소를 선택 후 클릭   | 2. 해당 대여소 상세정보 표시(대여소 이름, 위치, 사용 가능 자전거) |
|  3. (option)사용 가능한 자전거가 없을 시 회원이 예약대기를 신청   | 4. 예약 대기 완료 시 회원에게 문자알림 전송 |
|              |                 |
|              |                 |
...
|             |2. 사용시간에 따라 비용을 산정하여 결제하고 요금 정보(대여 시간, 요금)를 전송한다.  |       |
|             | |3. 요금 정보를 출력 한다.                 |
